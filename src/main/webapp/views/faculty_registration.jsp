...
<body style="background-color: lavender;">
	...
	<div class="text-center wow fadeInDown" align="center">
		...
		</br> <img src="https://pngimage.net/wp-content/uploads/2018/06/logo-user-png-4.png"
			alt="user icon" class="logo" height="130px" width="120px">

		<form action="/faculty_registration" class="needs-validation" novalidate>
			...
			<div class="form-fild" align="center">
				<label for="contactNo">Contact No: <a 
					data-toggle="tooltip" data-placement="top"
			...
			<div class="form-fild" align="center">
				<label for="password">Password: <a s
					data-toggle="tooltip" data-placement="top"
			...
			<p>
				Already Registered ? <a href="faculty_login_page">Login Here</a>
			</p>
