...
<form action="/forgot_user_id_faculty" class="needs-validation" novalidate method ="post">
	...
	<center><button type="submit" class="btn btn-primary">Get UserId</button></center><br>
</form>
<h3 align="center">Your UserId is ${faculty.getFacultyId()}</h3>
</body>
</html>